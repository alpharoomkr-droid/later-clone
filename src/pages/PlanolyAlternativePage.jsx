    ...
    <div style={{ paddingTop: 70, background: '#FEFCFB' }}>
      ...
      <section className="reveal">
        <div className="max-w-[1440px] mx-auto px-[40px]" style={{ padding: '100px 40px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 18, color: '#555', marginBottom: 56, maxWidth: 680, marginLeft: 'auto', marginRight: 'auto' }}>Social scheduling, Link in Bio, and brand partnerships – get them all with Later.</p>
      ...
      <section className="wood-bg reveal">
        <div className="max-w-[1440px] mx-auto px-[40px]" style={{ padding: '100px 40px' }}>
          <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: 42, textAlign: 'center', marginBottom: 48 }}>Later vs. Planoly at a glance</h2>
