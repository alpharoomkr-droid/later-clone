...
const BENEFITS = [
  { icon: 'https://images.ctfassets.net/nfpsrlop6sws/4biG0qn6WRvNYFiAZOY09Y/9e84d0713d8bbf1fa003af05ec2482cd/Later_Icon_SocialMediaMgmt.png', title: 'The easiest way to find influencers', desc: "Later's AI-driven tools use advanced filters to help you search for influencers based on over 20 criteria." },
  { icon: 'https://images.ctfassets.net/nfpsrlop6sws/1uT44PqVqmwMoRhV7xzgkN/0c77c42ca3e45d46b9d134f1c1b208d7/rocket-icon.png', title: 'Automated influencer campaign workflows', desc: "Scale your impact with intelligent automations that ensure your campaigns reach their full potential while making your team's life easier." },
  { icon: 'https://images.ctfassets.net/nfpsrlop6sws/vzviWwmvxikY8nIWgyKGC/9341d7929ce4da29fbf0f089e5f26c50/icon-plant.png', title: 'Track all performance in real-time', desc: 'Later reports on everything you need to share with your team to show campaign success.' },
  { icon: 'https://images.ctfassets.net/nfpsrlop6sws/2TFMduJpudJQZp5d2eDHee/b0c01b8a08ec6c4e3c10b0d719f51a85/icon-lead.png', title: "All-in-one pricing, no surprises", desc: "Later doesn't charge you for extra users, campaigns, creators, or reports in the platform — it's all included!" },
]

const COMPARISON = [
  { feature: 'All-in-one pricing', later: true, competitor: false },
  { feature: 'In-house managed services', later: true, competitor: 'Limited' },
  { feature: 'All influencer data authenticated via social API', later: true, competitor: false },
  { feature: 'Reviews and research', later: true, competitor: false },
  { feature: 'Private-label your platform experience', later: true, competitor: false },
  { feature: 'Pay/incentivize creators', later: 'Cash (Stripe), ACH, gift cards, product, contests', competitor: 'Cash (PayPal)' },
]

const NUMBERED = [
  { num: '01', title: 'Maximize your ROI for influencer marketing', desc: 'Later helps you partner with the right influencers who actually reach your audience, so you always get the best results.', img: 'https://images.ctfassets.net/nfpsrlop6sws/7gvJVqh7G6odqkMtCqMGjL/c422fc95fc0c02d5fa0a2e45337d5232/tagger-alternative-maximize-your-ROI-for-influencer-marketing-with-later.png?fm=webp&q=75&w=1136&h=960' },
  { num: '02', title: 'Manage creator payments and measure program ROI', desc: 'No more toggling between apps. With Later, you can manage your social media, influencer marketing, and link in bio in one seamless app.', img: 'https://images.ctfassets.net/nfpsrlop6sws/7uMzMFgJDjoiw9TlIc3t2Y/49b7c38b50c8011970bbf0639750efed/tagger-alternative-manage-creator-payments-and-measure-ROI-with-later.png?fm=webp&q=75&w=1136&h=960' },
  { num: '03', title: 'Seamless campaign management', desc: "Our expert services team handles all the nitty gritty campaign work so you don't have to. Sprout Social Influencer Marketing's managed services team is known to be small and unresponsive.", img: 'https://images.ctfassets.net/nfpsrlop6sws/5neTAgClQctpON1RerV0Ih/81955ceb07e62c260f5ad144f9fdd0b7/tagger-alternative-seamless-campaign-management-with-later.png?fm=webp&q=75&w=1136&h=960' },
...
export default function TaggerAlternativePage() {
  return (
        ...
        <div className="max-w-[1440px] mx-auto px-[40px]" style={{ padding: '60px 40px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 36, alignItems: 'center' }}>
            <div>
              ...
              <p style={{ fontSize: 18, lineHeight: 1.6, color: '#444', marginBottom: 32, maxWidth: 520 }}>Unlike Sprout Social Influencer Marketing, Later's in-house services team provides our customers with a full suite of services to supercharge their influencer marketing strategy and optimize their investments. Plus, you get clear, transparent pricing — no surprise costs for extra seats, campaigns, creators, or reports.</p>
              <a href="/demo/" className="btn-dark" style={{ display: 'inline-flex', alignItems: 'center', gap: 8 }}>Book a demo <ArrowIcon /></a>
            </div>
            <div>
              <img src="https://images.ctfassets.net/nfpsrlop6sws/4ksp5thDG5MMAyXv3879Sf/f97e76e448957f1eede6442f612c749a/tagger-alternative-hero.png?w=1136&h=961&q=80&fm=png" alt="Later vs Sprout Social Influencer Marketing" style={{ width: '100%', borderRadius: 16 }} />
            </div>
          </div>
        </div>
      </section>
