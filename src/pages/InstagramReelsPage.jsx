    ...
    <div style={{ paddingTop: 70 }}>
      ...
      <section style={{ padding: '80px 40px' }}>
        <div className="max-w-[1440px] mx-auto reveal">
          ...
          <p className="text-center" style={{ fontSize: 18, color: '#555', marginBottom: 56, maxWidth: 640, marginLeft: 'auto', marginRight: 'auto' }}>Later Social lets you schedule Instagram Reels in a few simple steps, no late-night logins required.</p>
      ...
      <section style={{ padding: '0 40px 80px' }}>
        <div className="max-w-[1440px] mx-auto">
          ...
          <h2 className="text-center reveal" style={{ fontFamily: 'var(--font-heading)', fontSize: 42, fontWeight: 900, lineHeight: 1.15, marginBottom: 64 }}>Posting Reels has never been easier</h2>
          {showcases.map((s, i) => (
      ...
      <section className="wood-bg" style={{ padding: '80px 40px' }}>
        <div className="max-w-[1440px] mx-auto reveal">
          ...
          <h2 className="text-center" style={{ fontFamily: 'var(--font-heading)', fontSize: 42, fontWeight: 900, lineHeight: 1.15, marginBottom: 56 }}>See why people love scheduling Reels with Later Social</h2>
