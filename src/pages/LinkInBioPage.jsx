  ...
  return (
    <div style={{ paddingTop: 70 }}>
      ...
      <section className="reveal" style={{ position: 'relative', background: '#000', overflow: 'hidden', padding: '70px 0' }}>
        ...
        />
        <div className="max-w-[1200px] mx-auto text-center" style={{ position: 'relative', zIndex: 1, paddingTop: 96, paddingBottom: 80 }}>
      ...
      <section className="reveal" style={{ borderBottom: '1px solid #eee' }}>
        <div className="max-w-[1200px] mx-auto" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 56, flexWrap: 'wrap', paddingTop: 40, paddingBottom: 40 }}>
