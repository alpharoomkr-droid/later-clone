...
const BENEFITS = [
  { icon: 'https://images.ctfassets.net/nfpsrlop6sws/55nuMdGWWe3p5bihOfhs7Y/f2c67885e361ce6899bdd4a1ccf62f80/auto-publish-icon.png', title: 'Automatically publish your posts', desc: 'Instagram posts, Reels, TikToks, you name it. Later lets you schedule ahead and save time while you\'re at it.' },
  { icon: 'https://images.ctfassets.net/nfpsrlop6sws/Twy4RBNMePPJKLsM9Vdvx/9c02bd4a69aa1d32cef3ca199b488859/icon-curate-feed-blue.svg', title: 'Curate the perfect feed', desc: 'Preview and rearrange upcoming posts to find the perfect vibe with Later\'s Visual Planner.' },
  { icon: 'https://images.ctfassets.net/nfpsrlop6sws/7kwn7JlAsTtsDwfI8XA5SZ/796def765fcad3fc4641322e4c874aee/icon-link-in-bio-growth.png', title: 'Make your grid shoppable with Link in Bio', desc: 'Drive traffic and increase sales with Link in Bio, Later\'s link in bio tool.' },
  { icon: 'https://images.ctfassets.net/nfpsrlop6sws/51RbGTsClb19G8pdDV1LuL/1346f559c98f79e3b2c48524391fe0ae/Collaboration.png', title: 'Collaborate on brand campaigns', desc: 'Later helps creators and brands to find each other and collaborate on social marketing campaigns.' },
]

const COMPARISON = [
  { feature: 'Best Time to Post for Instagram and TikTok', later: true, buffer: 'Instagram only' },
  { feature: 'Visually plan Instagram grid', later: true, buffer: false },
  { feature: 'Unlimited media storage', later: true, buffer: false },
  { feature: 'Instagram hashtag suggestions', later: true, buffer: false },
  { feature: 'Search and Share user-generated content', later: true, buffer: false },
  { feature: 'Social listening', later: true, buffer: false },
  { feature: 'Reply to Facebook and Instagram DMs', later: true, buffer: false },
  { feature: 'Team collaboration tools', later: true, buffer: true },
  { feature: 'Approval workflows', later: true, buffer: true },
  { feature: 'Tag products from your Instagram Shop', later: true, buffer: true },
  { feature: 'Manage your customizable Link in Bio page', later: true, buffer: true },
  { feature: 'Creator and brand collabs', later: true, buffer: false },
]

const NUMBERED = [
  { num: '01', title: 'Save time & grow your brand with scheduling tools', desc: 'Store all of your photos & videos in our Media Library, automatically publish posts, and search for user-generated content all in the app.', img: 'https://images.ctfassets.net/nfpsrlop6sws/2GNOenu9ZuB04QNp8fAybO/6f33dc1f087baa5e1fcb7743867891a2/later-multi-profile-scheduling.png?fm=webp&q=75&w=1136&h=960' },
  { num: '02', title: 'Boost strategy & engagement with visual-first features', desc: 'Create on-brand content in seconds with Later\'s Visual Planner and post at the perfect time for more engagement with our Best Time to Post tool.', img: 'https://images.ctfassets.net/nfpsrlop6sws/6OfkS2S30oIAHD7N7O959p/cd0a6db3ea4813f72b6f4229bb9d0cdd/later-visual-planner.png?fm=webp&q=75&w=1136&h=846' },
  { num: '03', title: 'Turn followers into customers with Link in Bio', desc: 'Use Link in Bio by Later to turn your Instagram and TikTok posts into clickable, shoppable images, complete with analytics that measure which content is driving revenue to your business.', img: 'https://images.ctfassets.net/nfpsrlop6sws/23rfmSLV1jEr7MRYoiGjG8/0cc87e4e783f2837a626baa30b5cc5a8/later-buffer-link-in-bio-tool.png?fm=webp&q=75&w=1136&h=960' },
]
          ...
          <div style={{
            ...
            <div>
              ...
              <h1 style={{
                ...
                Why Later is the best Buffer alternative
              </h1>
              <p style={{
                fontSize: 18,
                lineHeight: 1.6,
                ...
                Later's brand-building tools take a visual-first approach for
                social media scheduling and social commerce. Plus, creator and
                brand partnerships help you grow your audience, boost
            ...
            <div>
              <img
                src="https://images.ctfassets.net/nfpsrlop6sws/01PksmHq5OdVnWpoEnJ4ls/6af2ef5f77a042380d723517fac6b5a3/later-buffer-alternative-features.png?w=1136&h=960&q=80&fm=png"
                alt="Later vs Buffer features"
      ...
      <section className="reveal">
        ...
        >
          <p style={{
            ...
            The Buffer alternative for you
          </p>
          <h2 style={{
            fontFamily: 'var(--font-heading)',
            fontSize: 42,
            ...
            One app. Endless tools for growth.
          </h2>
          <p style={{
            fontSize: 18,
            color: '#555',
            ...
            Unlike Buffer, Later helps you manage your social marketing, social
            commerce and brand partnerships in one platform
          </p>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ background: '#000', color: '#fff' }}>
                  ...
                  <th style={{ padding: '16px 24px', textAlign: 'center', fontWeight: 600, fontSize: 15, width: 140 }}>Buffer</th>
                </tr>
              </thead>
              <tbody>
                {COMPARISON.map((row, i) => (
                  <tr key={row.feature} style={{ background: i % 2 === 0 ? '#fff' : '#f9f7f4' }}>
                    ...
                    <td style={{ padding: '14px 24px', textAlign: 'center' }}><span style={{ display: 'inline-flex', justifyContent: 'center' }}><CellIcon value={row.buffer} /></span></td>
                  </tr>
                ))}
              </tbody>
            </table>
