    ...
    <div style={{ paddingTop: 70, background: '#FEFCFB' }}>
      ...
      <section className="wood-bg reveal">
        <div className="max-w-[1440px] mx-auto px-[40px]" style={{ padding: '100px 40px' }}>
          <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: 42, textAlign: 'center', marginBottom: 48 }}>Later vs. GRIN at a glance</h2>
      ...
      <section className="reveal">
        <div className="max-w-[1440px] mx-auto px-[40px]" style={{ padding: '100px 40px' }}>
          ...
          <p style={{ fontSize: 18, color: '#555', textAlign: 'center', marginBottom: 64 }}>Later is easier to set up than GRIN — see for yourself with a free demo.</p>
          {NUMBERED.map((item, i) => (
