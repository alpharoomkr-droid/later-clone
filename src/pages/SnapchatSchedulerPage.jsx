    ...
    <div style={{ paddingTop: 70 }}>
      ...
      <section style={{ padding: '80px 40px' }}>
        <div className="max-w-[1440px] mx-auto text-center reveal">
          ...
          <p style={{ fontSize: 18, color: '#555', marginBottom: 56 }}>Dial in your Snapchat strategy with easy scheduling tools.</p>
      ...
      <section style={{ padding: '80px 40px' }}>
        <div className="max-w-[1440px] mx-auto">
          ...
          <h2 className="text-center reveal" style={{ fontFamily: 'var(--font-heading)', fontSize: 42, fontWeight: 900, lineHeight: 1.15, marginBottom: 64 }}>Your Snaps, scheduled your way.</h2>
          <div className="reveal" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'center', marginBottom: 80 }}>
